...
row.low <- read.csv(file = here::here('results', 'lowout.csv'))
row.med <- read.csv(file = here::here('results', 'medout.csv'))
row.high <- read.csv(file = here::here('results', 'highout.csv'))
