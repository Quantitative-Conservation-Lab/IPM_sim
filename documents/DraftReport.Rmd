...
$f_t \sim Uniform(0, 20) $
priors for rho or R?

likelihood
$L_P(\text{J}, \text{R}|\text{f})$
...
Equations
  ...
  $ S_{1,ad} \sim uniform(0,1)$
  $ p \sim uniform(0,1)$
  
  likelihood

  $L_{SS}(\text{y}|\text{z}, \text{S_juv}, \text{S_ad}, \text{p}) = L_O(\text{y}|\text{z},\text{p})     \times L_S(\text{z}|\text{S_juv}, \text{S_ad})$
