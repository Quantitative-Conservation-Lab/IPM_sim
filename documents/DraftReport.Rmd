...
We aim to improve our understanding of this important statistical approach, particularly for passerine bird life history. In this study, we simulate data to examine IPM performance across a range of scenarios where data informing key demographic parameters are sparse or missing. We simulate three datasets for a for a theoretical passerine: 1) census counts, 2) reproductive output, and 3) mark-recapture (MR) of banded individuals. We then systematically vary the uncertainty in our abundance and MR data and run the integrated models under scenarios where demographic parameters like survival and fecundity are high or low. By identifying scenarios where IPMs do not lead to improved precision or cannot estimate unidentifiable parameters, we refine our understanding of the mechanisms underlying IPMs and can better identify when they may serve as a useful tool. 
